...
QT_MOC_LITERAL(1, 13, 19), // "book_insert_confirm"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 4), // "Book"
QT_MOC_LITERAL(4, 39, 4), // "book"
QT_MOC_LITERAL(5, 44, 18), // "cancelButton_click"
QT_MOC_LITERAL(6, 63, 19) // "confirmButton_click"

    },
    "InsertDialog\0book_insert_confirm\0\0"
    "Book\0book\0cancelButton_click\0"
    "confirmButton_click"
};
...
void InsertDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->book_insert_confirm((*reinterpret_cast< Book(*)>(_a[1]))); break;
        ...
        {
            using _t = void (InsertDialog::*)(Book );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InsertDialog::book_insert_confirm)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InsertDialog::book_insert_confirm(Book _t1)
{
